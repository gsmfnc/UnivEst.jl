...
# alpha = 5e00
estp = [-0.5592347625533411, -5.052077689013563, 0.4358405148747074,
    -0.4549924100291462, -0.7669395975235528]
...
dV_values = get_lyapunov_derivative_values(sys_to_ctrl, quiv_points, estp);
p1 = plot_lyapunov_derivative_values_2d(quiv_points, dV_values);

plot(p1, quivplot, layout = (2, 1))
